...
namespace Ant.Wpf.Core
{
    ...
    public class AppearanceManager : NotifyPropertyChanged
    {
        ...
        /// </summary>
        public static readonly Uri DarkThemeSource = new Uri("/Ant.Wpf;component/Themes/ModernUI.Dark.xaml", UriKind.Relative);
        /// <summary>
        /// The location of the light theme resource dictionary.
        /// </summary>
        public static readonly Uri LightThemeSource = new Uri("/Ant.Wpf;component/Themes/ModernUI.Light.xaml", UriKind.Relative);
        ...
        private Uri ToUri(object value)
        {
            ...
            if (uri == null)
            {
                if (!(value is string uriString) || !Uri.TryCreate(uriString, UriKind.RelativeOrAbsolute, out uri))
