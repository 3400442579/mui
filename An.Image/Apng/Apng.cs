...
namespace An.Image.APNG
{
    ...
    internal class Apng : IDisposable
    {
        ...
        /*
        internal static BitmapSource MakeFrame(System.Drawing.Size fullSize, BitmapSource rawFrame, Frame frame, BitmapSource baseFrame)
        {
        ...
        public static BitmapSource ClearArea(BitmapSource frame, Frame metadata)
        {
            var visual = new DrawingVisual();
            using (var context = visual.RenderOpen())
            {
