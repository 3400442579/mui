...
namespace APNGLib
{
    public class FcTLChunk : PNGChunk
    {
        ...
        private readonly ushort[] AcceptedDisposeOps = { 0, 1, 2 };
        private readonly ushort[] AcceptedBlendOps = { 0, 1 };
