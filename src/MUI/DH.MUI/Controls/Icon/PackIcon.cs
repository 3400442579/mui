...
namespace DH.MUI.Controls
{
    public class PackIcon : Control
    {
        ...
        public static readonly DependencyProperty KindProperty
            = DependencyProperty.Register(nameof(Kind), typeof(PackIconKind), typeof(PackIcon), new PropertyMetadata(default(PackIconKind), (dependencyObject, dependencyPropertyChangedEventArgs) => ((PackIcon)dependencyObject).UpdateData()));
