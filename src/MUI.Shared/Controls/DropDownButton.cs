...
namespace DH.MUI.Controls
{
    ...
    [StyleTypedProperty(Property = nameof(MenuStyle), StyleTargetType = typeof(Menu))]
    public class DropDownButton : ItemsControl
    {
        /// <summary>Identifies the <see cref="Click"/> routed event.</summary>
        public static readonly RoutedEvent ClickEvent = EventManager.RegisterRoutedEvent(nameof(Click), RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DropDownButton));
        ...
        protected virtual void SetContextMenuPlacementTarget(ContextMenu contextMenu)
        {
            ...
            {
                contextMenu?.SetCurrentValue(ContextMenu.PlacementTargetProperty, this._clickButton);
            }
        }
        ...
        public static readonly DependencyProperty ExtraTagProperty = DependencyProperty.Register(
                nameof(ExtraTag),
                typeof(object),
                typeof(DropDownButton));
        ...
        public static readonly DependencyProperty MenuStyleProperty = DependencyProperty.Register(
                nameof(MenuStyle),
                typeof(Style),
                typeof(DropDownButton),
                new FrameworkPropertyMetadata(default(Style), FrameworkPropertyMetadataOptions.Inherits | FrameworkPropertyMetadataOptions.AffectsArrange | FrameworkPropertyMetadataOptions.AffectsMeasure));
        ...
        protected override void OnItemsChanged(NotifyCollectionChangedEventArgs e)
        {
            ...
            if (this._contextMenu == null || this.ItemsSource != null || this._contextMenu.ItemsSource != null|| e == null)
            {
                return;
            }
