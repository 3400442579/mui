...
namespace DH.MUI.Win32
{
    ...
    public static class OSVersionHelper
    {
        ...
        private static readonly Dictionary<KnownOS, OsEntry> osEntries = new Dictionary<KnownOS, OsEntry>{
        ...
        private static readonly bool? isServer = null;
        ...
        internal static bool IsWindowsVersionOrGreater(uint majorVersion, uint minorVersion, ushort servicePackMajor)
        {
            ...
            {
                versionOrGreaterTypeMask = VER_MAJORVERSION | VER_MINORVERSION | VER_SERVICEPACKMAJOR;
            }
        ...
        public static bool IsWindowsVersionOrGreater(KnownOS os)
        {
            ...
            {
                osEntry.MatchesOrGreater = IsWindowsVersionOrGreater(osEntry.MajorVersion, osEntry.MinorVersion, osEntry.ServicePackMajor);
            }
