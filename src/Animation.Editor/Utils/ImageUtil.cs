...
using GifFile = Animation.Editor.Utils.Gif.Decoder.GifFile;
...
namespace Animation.Editor.Utils
{
    public static class ImageUtil
    {
        ...
        //public static List<Frame> PaintTransparentAndCut(List<Frame> listToEncode, System.Windows.Media.Color transparent, int id, CancellationTokenSource tokenSource)
        //{
        //    //First frame rect.
        ...
        //public static List<Frame> PaintTransparentAndCutOld(List<Frame> listToEncode, Color transparent, int id, CancellationTokenSource tokenSource)
        //{
        //    //First frame rect.
        //    var size = listToEncode[0].Path.ScaledSize();
        //    listToEncode[0].Rect = new Int32Rect(0, 0, (int)size.Width, (int)size.Height);
        ...
        //        using (var imageSave2 = new Bitmap(imageAux2.Clone(new Rectangle(firstX, firstY, widthCut, heightCut), imageAux2.PixelFormat)))
        //        {
        //            imageAux2.Dispose();
        //            imageAux1.Dispose();
        ...
        ///// <param name="tokenSource">The cancelation token source.</param>
        //public static List<Frame> CutUnchanged(List<Frame> listToEncode, int id, CancellationTokenSource tokenSource)
        //{
        //    //First frame rect.
        //    var size = listToEncode[0].Path.ScaledSize();
        //    listToEncode[0].Rect = new Int32Rect(0, 0, (int)size.Width, (int)size.Height);
        ...
        //public static double CalculateDifference(Models.Frame first, Models.Frame second)
        //{
        //    #region Get Image Info
        ...
        //            //y - height - up/down
        //            for (var y = 0; y < height; y++)
        //                equalCount += (image1.GetPixel(x, y) == image2.GetPixel(x, y) ? 1 : 0);
        //        }
